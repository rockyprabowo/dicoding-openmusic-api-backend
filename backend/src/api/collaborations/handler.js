...
const { CollaborationRequestPayload } = require('@openmusic/common/types/data/collaboration/index')

/**
 * Collaborations Plugin - Route Handler
 *
 * @typedef {import('./routes')} CollaborationsRoute
 * @typedef {import('@openmusic/common/data/collaboration/collaboration')} Collaboration
 */
